...
| *Document Name:* | RFC 6455
| *Document URI:* | `urn:ietf:rfc:6455`
...
[`ws`](/concepts/uri-scheme/ws "The only operation for this scheme is to open a connection using the WebSocket Protocol."), [`wss`](/concepts/uri-scheme/wss "The only operation for this scheme is to open a connection using the WebSocket Protocol, encrypted using TLS.")
