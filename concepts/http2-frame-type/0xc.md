...
[This HTTP/2 ORIGIN frame type allows a server to indicate what origin(s) the server would like the client to consider as members of the Origin Set for the connection within which it occurs.](https://datatracker.ietf.org/doc/html/rfc8336#section-2 "Read documentation for HTTP/2 Frame Type &#34;0xc&#34;") (**[RFC 8336: The ORIGIN HTTP/2 Frame](/webconcepts/specs/IETF/RFC/8336 "This document specifies the ORIGIN frame for HTTP/2, to indicate what origins are available on a given connection.")**)
