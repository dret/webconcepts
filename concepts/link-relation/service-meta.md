...
description: "The \"service-meta\" link relation type is used to link to available metadata for the service context of a resource. It identifies a resource that is providing a service description that is primarily intended for machine consumption. In many cases, it is provided in a representation that is consumed by tools, code libraries, or similar components."
---
