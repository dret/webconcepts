...
description: "The \"service-desc\" link relation type is used to represent the fact that a resource is part of a bigger set of resources that are described at a specific URI. It identifies a resource that is providing a service description that is intended for machine consumption. Often, it is provided in a format that is consumed by tools, code libraries, or similar components."
---
