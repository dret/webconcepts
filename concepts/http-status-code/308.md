...
[The 308 (Permanent Redirect) status code indicates that the target resource has been assigned a new permanent URI and any future references to this resource ought to use one of the enclosed URIs.](https://datatracker.ietf.org/doc/html/rfc7538#section-3 "Read documentation for HTTP Status Code &#34;308&#34;") (**[RFC 7538: The Hypertext Transfer Protocol Status Code 308 (Permanent Redirect)](/webconcepts/specs/IETF/RFC/7538 "This document specifies the additional Hypertext Transfer Protocol (HTTP) status code 308 (Permanent Redirect).")**)
