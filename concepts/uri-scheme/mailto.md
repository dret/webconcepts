...
[A 'mailto' URI designates an "Internet resource", which is the mailbox specified in the address.](https://datatracker.ietf.org/doc/html/rfc6068#section-3 "Read documentation for URI Scheme &#34;mailto&#34;") (**[RFC 6068: The 'mailto' URI Scheme](/webconcepts/specs/IETF/RFC/6068 "This document defines the format of Uniform Resource Identifiers (URIs) to identify resources that are reached using Internet mail. It adds better internationalization and compatibility with Internationalized Resource Identifiers to the previous syntax of 'mailto' URIs.")**)
