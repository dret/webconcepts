...
[The "handling=strict" and "handling=lenient" preferences indicate, at the server's discretion, how the client wishes the server to handle potential error conditions that can arise in the processing of a request.](https://datatracker.ietf.org/doc/html/rfc7240#section-4.4 "Read documentation for HTTP Preference &#34;handling&#34;") (**[RFC 7240: Prefer Header for HTTP](/webconcepts/specs/IETF/RFC/7240 "This specification defines an HTTP header field that can be used by a client to request that certain behaviors be employed by a server while processing a request.")**)
