...
[An API Health Response Format (or, interchangeably, "health check response") uses the format described in RFC 8259 and has the media type "application/vnd.health+json". Its content consists of a single mandatory root field ("status") and several optional fields.](https://datatracker.ietf.org/doc/html/draft-inadarei-api-health-check#section-3 "Read documentation for Media Type &#34;application/vnd.health+json&#34;") (**[Internet Draft inadarei-api-health-check: Health Check Response Format for HTTP APIs](/webconcepts/specs/IETF/I-D/inadarei-api-health-check "This document proposes a service health check response format for HTTP APIs.")**)
